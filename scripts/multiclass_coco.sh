...
common="--lr 0.001  --input  'coco --path /storage/storage/coco' --no_load --train_epochs 60 --crop_boxes --image_size 512 --batch_size 16 --epoch_size 8192 --log_dir /local/storage/logs/multiclass_coco/" 
